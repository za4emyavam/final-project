        ...
        <form action="${pageContext.request.contextPath}/admin/registration" method="post"
            ...
            <div class="w3-container w3-inline-input-group">
                ...
                <input class="w3-input w3-border w3-input-group-addon w3-col" style="width: 300px" id="telephone_number"
                       name="telephone_number" placeholder="${telephone}" required="required"
                       pattern="^\+38[0-9\-\+]{9,15}$">
                <br><br>
                ...
                <button class="w3-btn w3-teal w3-input-group-addon w3-col" style="width: 300px" type="submit">
                    <fmt:message key="admin.registration.button.register"/>
                </button>
            </div>
        </form>
    </div>
